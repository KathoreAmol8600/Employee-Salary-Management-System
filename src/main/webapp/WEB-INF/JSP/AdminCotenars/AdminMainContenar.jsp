...
<body>
	...
	<div class="card bg-dark text-white text-center">
		<img src="resources/Images/pexels-lumn-295771.jpg" class="card-img"
			alt="Background Image">
		<div
			class="card-img-overlay d-flex flex-column justify-content-center align-items-center">
			<div class="card-header bg-transparent border-8"
	...
	<div class="container-fluid mt-4">
				...
				<div class="dashboard-card bg-light text-black p-2">
					...
					<div class="d-flex justify-content-between mt-2">
						<a href="view-department" class="btn btn-primary">View
							Department</a>
							 <a href="inputFrom-adddepartment" class="btn btn-secondary">Add
							Department</a>
					</div>
				</div>
			</div>
		...
		<div class="row mt-4">
			<div class="col-md-18 d-flex justify-content-center">
				<div class="dashboard-card  text-black" style="">
	...
	<div class="container my-3">
		<h2 class="text-center mb-4">Employee Request to Admin To
			Smothing Change</h2>
		<div id="testimonialsCarousel" class="carousel slide "
			...
			<div class="carousel-inner">
				<div class="carousel-item active">
					<div class="card mb-4 bg-white  text-black">
						<div class="card-body text-center">
							<p class="card-text">"Amazing service! I highly recommend
								them."</p>
							Employee
								Name
						</div>
				...
				<div class="carousel-item">
					<div class="card mb-4 bg-white  text-black">
						<div class="card-body text-center">
							<p class="card-text">"I couldn't be happier with the
								results."</p>
							Employee
								Name
						</div>
			...
			<a class="carousel-control-prev" href="#testimonialsCarousel"
				role="button" data-bs-slide="prev"> <span
				class="carousel-control-prev-icon" aria-hidden="true"></span> <span
				class="visually-hidden">Previous</span>
			</a> <a class="carousel-control-next" href="#testimonialsCarousel"
